...
export default function Solution() {
  return (
    <section id="product" className="py-32 md:py-40">
      <div className="mx-auto max-w-content px-6">
        ...
        <div className="mt-20 grid grid-cols-2 md:grid-cols-3 gap-6 md:gap-8">
          {capabilities.map((cap) => (
            <div
              key={cap.name}
              className="group rounded-2xl border border-black/5 bg-white p-8 md:p-10 hover:border-black/10 hover:shadow-lg transition-all duration-300"
            >
